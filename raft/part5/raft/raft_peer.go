...
func (reply RequestVoteReply) String() string {
	return fmt.Sprintf(
		...
		reply.Term, reply.LeaderId, reply.VotedGrand,
	)
}
...
func (rp *RaftPeer) requestVote(args interface{}, reply interface{}) error {
	...
	if err := rp.rpcClient.Call("RaftNode.HandleRequestVote", args, reply); err != nil {
		return err
	}
	return nil
}
...
func (rp *RaftPeer) appendEntries(args AppendEntriesArgs, reply *AppendEntriesReply) error {
	...
	if err := rp.rpcClient.Call("RaftNode.HandleAppendEntries", args, reply); err != nil {
		return err
	}
	return nil
}
